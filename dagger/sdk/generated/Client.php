...
class Client extends Client\AbstractClient
{
    ...
    /**
     * Load a Php from its ID.
     */
    public function loadPhpFromID(PhpId|Php $id): Php
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('loadPhpFromID');
        $innerQueryBuilder->setArgument('id', $id);
        return new \Dagger\Php($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
    ...
    {
        $innerQueryBuilder = new \Dagger\Client\QueryBuilder('php');
        return new \Dagger\Php($this->client, $this->queryBuilderChain->chain($innerQueryBuilder));
    }
